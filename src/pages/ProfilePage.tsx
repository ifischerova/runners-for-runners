  ...
  return (
    <div className="section-container max-w-3xl mx-auto animate-fade-in">
      <div className="text-center mb-8">
        ...
        <p className="text-dark-600">{t('profile.welcome', { name: user.username })}</p>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center p-4 bg-gradient-to-r from-primary-50 to-primary-100 rounded-xl">
            ...
            <div className="flex-1">
              <span className="text-sm text-dark-600 block">{t('profile.username')}</span>
          ...
          <div className="flex items-center p-4 bg-gradient-to-r from-accent-50 to-accent-100 rounded-xl">
            <span className="text-2xl mr-4"></span>
            <div className="flex-1">
              <span className="text-sm text-dark-600 block">{t('profile.email')}</span>
          ...
          {user.firstName && (
            <div className="flex items-center p-4 bg-gradient-to-r from-primary-50 to-primary-100 rounded-xl">
              <span className="text-2xl mr-4"></span>
              <div className="flex-1">
                <span className="text-sm text-dark-600 block">{t('profile.name')}</span>
          ...
          {user.city && (
            <div className="flex items-center p-4 bg-gradient-to-r from-accent-50 to-accent-100 rounded-xl">
              <span className="text-2xl mr-4"></span>
              <div className="flex-1">
                <span className="text-sm text-dark-600 block">{t('profile.city')}</span>
          ...
          <div className="flex items-center p-4 bg-gradient-to-r from-primary-50 to-primary-100 rounded-xl">
            <span className="text-2xl mr-4"></span>
            <div className="flex-1">
              <span className="text-sm text-dark-600 block">{t('profile.role')}</span>
              <span className="font-semibold text-dark-800">{isAdmin ? t('profile.role.admin') : t('profile.role.user')}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="glass-card p-8">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-dark-600 text-lg mb-2">{t('profile.rides.placeholder1')}</p>
          <p className="text-sm text-dark-500">{t('profile.rides.placeholder2')}</p>
        </div>
      </div>
    </div>
  );
